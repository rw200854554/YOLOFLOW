...
from ultralytics.data.utils import IMG_FORMATS, VID_FORMATS, NP_FORMATS
...
class LoadImages:
    ...
    def __init__(self, path, imgsz=640, vid_stride=1):
        ...
        images = [x for x in files if x.split('.')[-1].lower() in NP_FORMATS]
        ...
        if any(videos):
            ...
            self.cap = None
        if self.nf == 0:
            raise FileNotFoundError(f'No images or videos or npy found in {p}. '
